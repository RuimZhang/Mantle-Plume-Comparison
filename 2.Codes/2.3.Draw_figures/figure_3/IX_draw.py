...
ax4 = figure.add_axes([0.92,0.57,0.02,0.4])
...
ax8 = figure.add_axes([0.92,0.12,0.02,0.4])
...
Y_length = 660
Z_length = 2000
I3_Path = "/Volumes/Mars_Base/9.Models/1.1.MPC/I3_Plume_noTail/T_2200/"
...
ax1.vlines([1000], 0, -660, linestyles='dashed', colors='black')
ax1.text(400, -600, '2D', fontsize = label_size, color = "black")
ax1.text(1300, -600, '3D Slice', fontsize = label_size, color = "black")
ax1.text(100, -640, '%.2f' % file_num + " (Myr)", fontsize = ticks_size, color = "black")
...
ax2.vlines([1000], 0, -660, linestyles='dashed', colors='black')
ax2.text(400, -600, '2D', fontsize = label_size, color = "black")
ax2.text(1300, -600, '3D Slice', fontsize = label_size, color = "black")
ax2.text(100, -640, '%.2f' % file_num + " (Myr)", fontsize = ticks_size, color = "black")
...
ax3.vlines([1000], 0, -660, linestyles='dashed', colors='black')
ax3.text(400, -600, '2D', fontsize = label_size, color = "black")
ax3.text(1300, -600, '3D Slice', fontsize = label_size, color = "black")
ax3.text(100, -640, '%.2f' % file_num + " (Myr)", fontsize = ticks_size, color = "black")
...
ax5.vlines([1000], 0, -660, linestyles='dashed', colors='black')
ax5.text(400, -600, '2D', fontsize = label_size, color = "black")
ax5.text(1300, -600, '3D Slice', fontsize = label_size, color = "black")
ax5.text(100, -640, '%.2f' % file_num + " (Myr)", fontsize = ticks_size, color = "black")
...
ax6.vlines([1000], 0, -660, linestyles='dashed', colors='black')
ax6.text(400, -600, '2D', fontsize = label_size, color = "black")
ax6.text(1300, -600, '3D Slice', fontsize = label_size, color = "black")
ax6.text(100, -640, '%.2f' % file_num + " (Myr)", fontsize = ticks_size, color = "black")
...
ax7.vlines([1000], 0, -660, linestyles='dashed', colors='black')
ax7.text(400, -600, '2D', fontsize = label_size, color = "black")
ax7.text(1300, -600, '3D Slice', fontsize = label_size, color = "black")
ax7.text(100, -640, '%.2f' % file_num + " (Myr)", fontsize = ticks_size, color = "black")
...
ax9.text(0.769, 0.1, '10', fontsize = label_size, color = "black")
...
plt.savefig("./Figure_3.png", dpi=300, format="png")